...
import { q as dispatch$1, l as rgbBasis, o as rgb, S as Stanza } from './timer-4a7721ea.js';
import { c as creator, S as Selection, a as array$4, r as root$1, b as SCHEDULED, T as Transition, i as interrupt, d as Transform, e as identity$8, f as cubicInOut, g as cubicIn, h as cubicOut, m as matcher, n as namespace, j as namespaces, s as selection, k as selector, l as selectorAll, o as styleValue, p as defaultView, t as transition, q as transform$1 } from './transform-450ed364.js';
import { s as select } from './select-7a3cbce4.js';
import { i as interpolate$1, p as path, t as tickStep$1, h as ticks$1, m as max$3, r as range$3, g as cubehelixLong$1, k as cubehelix$4, e as interpolateZoom } from './cubehelix-5f04aade.js';
import { I as InternMap, m as max$2, d as InternSet, R as Rgb, r as rgbConvert, e as define, g as extend, C as Color, j as brighter, k as darker, l as exponent$1, n as optional, N as Node$1, t as treemapDice, q as required, u as roundNode, v as hue$1, w as interpolateNumber, x as hsl$2, y as nogamma, i as interpolate$2, o as ordinal, z as initRange, A as formatSpecifier, B as formatPrefix, f as format, D as initInterpolator, c as path$1, E as constant$9, F as tau$4, G as pi$3, H as epsilon$5, b as sum$2, J as color, K as rgb$1, L as defaultLocale$1, M as formatLocale$1, O as FormatSpecifier, h as hierarchy, p as partition, s as stratify, P as array$5, Q as basis$1, S as basisClosed$1, T as date$1, U as numberArray, V as object$1, W as string, X as rgb$2, Y as rgbBasis$1, Z as rgbBasisClosed, _ as implicit, a as arc } from './arc-a7e8258b.js';
import { a as text, d as dsv$1, c as csv$1, t as tsv$1 } from './dsv-9b0090c9.js';
...
function selectAll(selector) {
  return typeof selector === "string"
      ...
      : new Selection([array$4(selector)], root$1);
}
...
const {abs: abs$2, max: max$1, min} = Math;
  ...
  function started(event) {
    ...
    function moved(event) {
      ...
      if (shifting && !lockX && !lockY && points.length === 1) {
        ...
        if (abs$2(point.cur[0] - point[0]) > abs$2(point.cur[1] - point[1]))
          lockY = true;
        else
          lockX = true;
      }
...
function contours() {
  ...
  function contours(values) {
    ...
    if (!Array.isArray(tz)) {
      const e = extent$2(values), ts = tickStep$1(e[0], e[1], tz);
  ...
  contours.thresholds = function(_) {
    return arguments.length ? (threshold = typeof _ === "function" ? _ : Array.isArray(_) ? constant$4(slice$1.call(_)) : constant$4(_), contours) : threshold;
  };
...
function density() {
  ...
  density.thresholds = function(_) {
    return arguments.length ? (threshold = typeof _ === "function" ? _ : Array.isArray(_) ? constant$4(slice$1.call(_)) : constant$4(_), density) : threshold;
  };
...
function longitude(point) {
  return abs(point[0]) <= pi ? point[0] : sign$1(point[0]) * ((abs(point[0]) + pi) % tau - pi);
}
...
function graticule() {
  ...
  function lines() {
    return range$2(ceil(X0 / DX) * DX, X1, DX).map(X)
        ...
        .concat(range$2(ceil(x0 / dx) * dx, x1, dx).filter(function(x) { return abs(x % DX) > epsilon; }).map(x))
        .concat(range$2(ceil(y0 / dy) * dy, y1, dy).filter(function(y) { return abs(y % DY) > epsilon; }).map(y));
  }
...
var cubehelix = cubehelixLong$1(cubehelix$4(300, 0.5, 0.0), cubehelix$4(-240, 0.5, 1.0));
...
function line(x$1, y$1) {
  ...
  x$1 = typeof x$1 === "function" ? x$1 : (x$1 === undefined) ? x : constant$9(x$1);
  y$1 = typeof y$1 === "function" ? y$1 : (y$1 === undefined) ? y : constant$9(y$1);
...
function area(x0, y0, y1) {
  ...
  x0 = typeof x0 === "function" ? x0 : (x0 === undefined) ? x : constant$9(+x0);
  y0 = typeof y0 === "function" ? y0 : (y0 === undefined) ? constant$9(0) : constant$9(+y0);
  y1 = typeof y1 === "function" ? y1 : (y1 === undefined) ? y : constant$9(+y1);
...
function link(curve) {
  ...
  link.x = function(_) {
    return arguments.length ? (x$1 = typeof _ === "function" ? _ : constant$9(+_), link) : x$1;
  };

  link.y = function(_) {
    return arguments.length ? (y$1 = typeof _ === "function" ? _ : constant$9(+_), link) : y$1;
  };
...
function symbol(type, size) {
  var context = null;
  type = typeof type === "function" ? type : constant$9(type || circle);
...
function stack() {
  ...
  stack.order = function(_) {
    return arguments.length ? (order = _ == null ? none : typeof _ === "function" ? _ : constant$9(Array.from(_)), stack) : order;
  };
  ...
  zoom.translateTo = function(selection, x, y, p, event) {
    zoom.transform(selection, function() {
      var e = extent.apply(this, arguments),
          t = this.__zoom,
          p0 = p == null ? centroid(e) : typeof p === "function" ? p.apply(this, arguments) : p;
      return constrain(identity$8.translate(p0[0], p0[1]).scale(t.k).translate(
        typeof x === "function" ? -x.apply(this, arguments) : -x,
        typeof y === "function" ? -y.apply(this, arguments) : -y
      ), e, translateExtent);
    }, p, event);
...
function draw(el, dataset, opts) {
  ...
  const y = linear().rangeRound([0, height]);
  ...
  const color = ordinal(d3[colorScale]);

  function tile(node, x0, y0, x1, y1) {
    binary(node, 0, 0, width, height);
  ...
  const treemap = (data) =>
    index().tile(tile)(
      hierarchy(data).sum((d) => d?.children?.length || 1)
  ...
  function render(group, root) {
    const dMax = max$2(root, (d) => d?.children?.length || 1);
    const dMin = min$1(root, (d) => d?.children?.length || 1);
  ...
  function wrap() {
    const text = select(this).selectAll("text");

    text.each(function () {
      let text = select(this);

      let rectWidth = select(text.node().parentNode)
        .select("rect")
        .node()
        .getAttribute("width");
  ...
  function zoomin(d) {
    ...
    svg
      ...
      .call((t) =>
        group1
          .transition(t)
          .attrTween("opacity", () => interpolate$2(0, 1))
          .call(position, d)
      )
      .on("end", wrap);
  }
    ...
    svg
      ...
      .call((t) =>
        group0
          .transition(t)
          .remove()
          .attrTween("opacity", () => interpolate$2(1, 0))
          .call(position, d)
      )
