...
import { d as downloadSvgMenuItem, a as downloadPngMenuItem, g as appendCustomCss, s as select$1 } from './index-8e15dd3b.js';
          ...
          <tbody>
            ${this.items.map((item) => {
              return p` <tr data-id="${item.id}">
                ...
                ${item.value
                  ? p`<td class="${(typeof item.value).toLowerCase()}">
                      ${item.value}
                    </td>`
                  : ""}
              </tr>`;
