import { T as Timer, w as dispatch, v as timer, i as interpolateNumber, f as color, g as interpolateRgb, h as interpolateString, p as interpolateTransformSvg, o as interpolateTransformCss, u as now } from './timer-18f52222.js';
...
function downloadSvgMenuItem(stanza, filenamePrefix) {
  return {
    type: "item",
    label: "Download SVG",
    handler: () => {
...
function downloadPngMenuItem(stanza, filenamePrefix) {
  return {
    type: "item",
    label: "Download PNG",
    handler: () => {
...
function downloadJSONMenuItem(stanza, filenamePrefix, data) {
  return {
    type: "item",
    label: "Download JSON",
    handler: () => {
...
function downloadCSVMenuItem(stanza, filenamePrefix, data) {
  return {
    type: "item",
    label: "Download CSV",
    handler: () => {
...
function downloadTSVMenuItem(stanza, filenamePrefix, data) {
  return {
    type: "item",
    label: "Download TSV",
    handler: () => {
...
export { downloadPngMenuItem as a, downloadJSONMenuItem as b, downloadCSVMenuItem as c, downloadSvgMenuItem as d, downloadTSVMenuItem as e, copyHTMLSnippetToClipboardMenuItem as f, appendCustomCss as g, select as s };
//# sourceMappingURL=index-8e15dd3b.js.map
